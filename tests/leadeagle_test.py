from leadeagle.server import api
from leadeagle.server import leadeagle
from leadeagle.server.extensions import database, migrate
...
# ALEMBIC_CONFIG = r'C:\Bibliotheken\Dokumente\hiwi_geomar\LeadEagle\lead-eagle\migrations\alembic.ini'
...
#     db_fd, leadeagle.app.config['SQLALCHEMY_DATABASE_URI'] = tempfile.mkstemp()
#     leadeagle.app.config['TESTING'] = True
#     client = leadeagle.app.test_client()

#     with leadeagle.app.app_context():
...
#     os.close(db_fd)
#     os.unlink(leadeagle.app.config['DATABASE'])
